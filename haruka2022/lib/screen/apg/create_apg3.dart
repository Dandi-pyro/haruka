...
class CreateApg3Screen extends StatefulWidget {
  const CreateApg3Screen({super.key});

  @override
  State<CreateApg3Screen> createState() => _CreateApg3ScreenState();
}

class _CreateApg3ScreenState extends State<CreateApg3Screen> {
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        bool isAvailable = await createApgProvider.postApg(
                          ...
                          "APG23-3/${_dokumenController.text}",
