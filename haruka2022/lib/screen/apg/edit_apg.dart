...
class EditApgScreen extends StatefulWidget {
  ...
  @override
  State<EditApgScreen> createState() => _EditApgScreenState();
}

class _EditApgScreenState extends State<EditApgScreen> {
  ...
  void initState() {
    super.initState();
    getUser().then((value) {
      _agendaItemController.text = widget.agendaItem;
      _dokumenController.text = widget.dokumen;
      _namaDokumenController.text = widget.namaDokumen;
      _sourceDokumenController.text = widget.sourceDokumen;
      _summaryDokumenController.text = widget.summaryDokumen;
      _tanggalDokumenController.text = widget.tanggalDokumen;
      _picStakeholderController.text = widget.picStakeholder;
      _picKominfoController.text = widget.picKominfo;
      _fileController.text = widget.file;
      dropdownAlokasi = widget.alokasi;
      setState(() {});
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final editApgProvider = Provider.of<EditApgProvider>(context);
    return Scaffold(
      appBar: AppBar(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        bool isAvailable = await editApgProvider.putApg(
                          widget.id,
                          dropdownAlokasi!,
                          _agendaItemController.text,
                          _dokumenController.text,
