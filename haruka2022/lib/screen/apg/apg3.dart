...
import 'package:haruka2022/screen/apg/create_apg3.dart';
...
class Apg3Screen extends StatefulWidget {
  const Apg3Screen({super.key});

  @override
  State<Apg3Screen> createState() => _Apg3ScreenState();
}

class _Apg3ScreenState extends State<Apg3Screen> {
  ...
  void initState() {
    super.initState();
    listApg = Provider.of<Apg3Provider>(context, listen: false).apg;
  }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CreateApg3Screen(),
            ),
          );
        },
        child: const Icon(
